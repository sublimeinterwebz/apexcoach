...
Generate exactly 7 days (${days} workouts, ${7-days} rest). Each workout session should have 5-7 exercises. Only use: ${equip}. Avoid exercises stressing: ${injuries}. Personalize meals for diet: ${diet}. Include warm-up and compound movements first, isolation exercises last.
